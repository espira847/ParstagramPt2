...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        *  3. An image View to show the pic the user has taken
        *  4. A button to send and save the post ot Parse server
         */
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground { exception ->
            if(exception != null){
                ...
                Toast.makeText(this, "Error while saving post", Toast.LENGTH_SHORT)
            } else {
                Log.i(TAG, "Successfully saved post")
                // TODO: reset edit text to be empty
